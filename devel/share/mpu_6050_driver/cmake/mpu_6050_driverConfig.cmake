...
if("TRUE" STREQUAL "TRUE")
  set(mpu_6050_driver_SOURCE_PREFIX /home/ayushg/calgary_ws/src/mpu_6050_driver)
  set(mpu_6050_driver_DEVEL_PREFIX /home/ayushg/calgary_ws/devel)
  ...
  set(mpu_6050_driver_INSTALL_PREFIX /home/ayushg/calgary_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Ayush Ghosh <ayush.ghosh@uwaterloo.ca>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu_6050_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ayushg/calgary_ws/src/mpu_6050_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ayushg/calgary_ws/devel/lib;/home/ayushg/calgary_ws/devel/lib;/opt/ros/noetic/lib)
